      ...
      <div className="grid-background"> </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 text-center lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {howItWorks.map((item, index) => {
                return (
                  <div key={index}>
                    <div className="w-16 h-16 m-3 bg-primary/10 rounded-full flex items-center justify-center mx-auto">
                      {item.icon}
                    </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-muted-50">
          <div className="container mx-auto px-4 md:px-6">
            ...
            {/* Frequesnlt asked quesxtion section */}
        ...
        <section className="w-full">
          <div className="mx-auto py-24 gradient rounded-lg">
            <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
              ...
              <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">Join thousands of professionals who are advancing their careers
                with AI-powered guidance
              </p>
              <Link href={"/dashboard"} passHref>
                <Button size="lg" className="mt-5 h-11 animate-bounce" variant="secondary">
